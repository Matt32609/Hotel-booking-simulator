...
This simulator was developed to enhance my understanding of using dictionaries, JSON concepts for saving user data, and functions. At the same time, this project also introduced me to the `random` and `datetime` modules to strengthen the realism of the simulator.

---------------------------------------
Key features of the code:
--------------------------------------
1. Dictionary-Driven Room Selection:
- I implemented a dictionary to map user inputs to specific room attributes, such as room name and nightly rate. This approach replaces long "if-else" chains with a cleaner, more scalable lookup system that manages everything from Standard rooms to the Penthouse.
